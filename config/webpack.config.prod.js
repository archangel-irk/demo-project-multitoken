                    ...
                    },
                    {
                      ...
                      options: {
                        ...
                        modifyVars: {
                          ...
                          '@btn-primary-bg': '#a254c1',

                          '@btn-danger-color': '#f9757d', // for click animation
                          '@btn-danger-bg': '#f9757d',

                          // Table
                          '@table-row-hover-bg': '#f0f6f7',
                        }
                      },
                    }
                  ],
                      ...
                      options: {
                        ...
                        plugins: () => [
                          ...
                          postCssPresetEnv({
                            stage: 3,
                            features: {
                              // Enable Tab Atkin's proposed syntax for nesting
